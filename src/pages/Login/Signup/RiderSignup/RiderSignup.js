...
const RiderSignup = () => {
    ...
    const handleOnChange = e => {
        ...
        const newdata = { ...newUserData, role: 'rider' }
        setUserdata(newdata);
    }
                ...
                <div className="row">
                    <div className="col-lg-4 col-md-4 col-12">
                        ...
                        <Form.Group className="mb-3" controlId="formBasicNumber">
                            ...
                            <Form.Control onChange={handleOnChange} required name="age" type="number" placeholder="Enter Your Age" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicText">
                    ...
                    <div className="col-lg-4 col-md-4 col-12">
                        <Form.Group className="mb-3" controlId="formBasicText">
                            ...
                            <Form.Control required onChange={handleOnChange} name="licenceImg" type="text" placeholder="Image Link" />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3" controlId="formBasicText">
                            ...
                            <Form.Control required onChange={handleOnChange} name="vehicleName" type="text" placeholder="Enter Vehicle Name" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicText">
                            <Form.Label>Vehicle Modle</Form.Label>
                            <Form.Control required onChange={handleOnChange} name="model" type="text" placeholder="Enter Vehicle Model" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicText">
                            <Form.Label>Vehicle Name Plate Information</Form.Label>
                            <Form.Control required type="text" onChange={handleOnChange} name="numberPlate" placeholder="Enter Name Plate Information" />
                        </Form.Group>
                    ...
                    <div className="col-lg-4 col-md-4 col-12">
                        <Form.Group className="mb-3" controlId="formBasicText">
                            ...
                            <Form.Control required onChange={handleOnChange} name="area" type="text" placeholder="Which Area You Want to Ride" />
                        </Form.Group>
                        <Form.Group className="mb-3" controlId="formBasicText">
